...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 833741677L;
    ...
    public final umc.umc7th_spring.domain.QMission mission;

    public final EnumPath<umc.umc7th_spring.domain.enums.MissionStatus> status = createEnum("status", umc.umc7th_spring.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc.umc7th_spring.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
